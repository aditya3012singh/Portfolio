      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I am currently pursuing B.Tech in Computer Science at KIET Group of Institutions.
            <br />
            I serve as Technical Coordinator at CPByte Technical Club, where I mentor students and lead technical initiatives.
            <br />
            <br />
