        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> Java, JavaScript, and modern web technologies. </b>
              </i>
              <br />
              <br />
              ...
              <br />
              <br />
              I develop applications using <b className="purple">Node.js</b>,{" "}
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/aditya-singh"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
